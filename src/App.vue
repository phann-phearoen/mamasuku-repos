    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white fixed-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="theNavbar">
          <ul
            class="navbar-nav ms-auto mt-4"
            :class="{ mr: screenMode === 'normal' }"
            v-scroll-spy-active="{
...
export default {
  ...
  watch: {
    screenWidth(val) {
      ...
      if (val > 1025) this.marginLeft = 9;
      else if (val > 768) this.marginLeft = 3;
      else this.marginLeft = 0;
    },
  },
