<template>
  <div class="q-pa-md">
    <q-card class="my-card items-center">
      ...
      <router-link
        class="column items-center link"
        to="/vue-pages/contact"
        @click="$scrollToTop"
      >
        <q-btn
          unelevated
...
export default {
  ...
  watch: {
    screenWidth(val) {
      if (val < 500) this.height = null;
      else if (val < 960) this.height = 13;
      else if (val < 1030) this.height = 16;
      else if (val < 1400) this.height = 13;
      else this.height = 10;
    },
  },
  created() {
